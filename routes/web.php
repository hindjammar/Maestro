...
Route::get('/product', function () {
    ...
    //events
    Route::get('/createProduct', [ProductController::class, 'showForm']);

    Route::post('/creProduct', [ProductController::class, 'store']);
...
Route::post('/form', [VehiculeController::class, 'store']);
...
Route::get('/filtarge',[FiltrageController::class, 'index']);
...
Route::get('/prods', [ExcelController::class, 'afficherProduct'])->name('prods');
