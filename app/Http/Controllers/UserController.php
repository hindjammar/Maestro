...
class UserController extends Controller
{
    ...
    {
        $creator = Auth::user();
        $totalProducts = Product::where('creator', $creator->id)->count();
        $products = Product::all();
        ...
        $LatestProducts = Product::limit(3)->where('creator', $creator->id)->get();

//        dd($totalEvents);

        return view('creator.dashboard', compact('totalProducts','LatestProducts','products','vehicules','couleurs','references'));
    }
